...
export class VecTestSuite extends wasm_pkg.TestSuite {
  ...
  test_vec_2(expect: (e: any) => wasm_pkg.TestExpectation): void {
  ...
  test_vec_3(expect: (e: any) => wasm_pkg.TestExpectation): void {
  ...
  test_vec_4(expect: (e: any) => wasm_pkg.TestExpectation): void {
