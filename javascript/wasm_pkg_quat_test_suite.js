...
exports.QuatTestSuite = void 0;
const wasm_pkg = __importStar(require("./wasm_pkg.js"));
class QuatTestSuite extends wasm_pkg.TestSuite {
    test_quat_1(expect) {
    ...
    test_quat_7(expect) {
       ...
       */
        ...
        expect(q_rot_ooo_120.apply_vec(x_axis).distance_sq(x_axis)).toBeCloseTo(2, 6);
        expect(q_rot_ooo_120
            .apply_vec(q_rot_ooo_120.apply_vec(x_axis))
            .distance_sq(x_axis)).toBeCloseTo(2, 6);
        // Three rotations is back to where we started
        expect(q_rot_ooo_120
            .apply_vec(q_rot_ooo_120.apply_vec(q_rot_ooo_120.apply_vec(x_axis)))
            .distance_sq(x_axis)).toBeCloseTo(0, 6);
    }
    test_quat_8(expect) {
...
exports.QuatTestSuite = QuatTestSuite;
//# sourceMappingURL=wasm_pkg_quat_test_suite.js.map