...
exports.MatTestSuite = void 0;
const wasm_pkg = __importStar(require("./wasm_pkg.js"));
class MatTestSuite extends wasm_pkg.TestSuite {
    test_mat_1(expect) {
    ...
    test_mat_2(expect) {
        ...
        expect(m0.determinant()).toBe(1 * (5 * 9 - 6 * 8) + 2 * (6 * 7 - 4 * 9) + 3 * (4 * 8 - 5 * 7));
        // Non-zero
        expect(m1.determinant()).toBe(2 * (6 * 10 - 6 * 8) + 2 * (6 * 7 - 4 * 10) + 3 * (4 * 8 - 6 * 7));
        m1.set_neg();
        {
            const a = m1.array;
            expect(a[0]).toBe(-2);
...
exports.MatTestSuite = MatTestSuite;
//# sourceMappingURL=wasm_pkg_mat_test_suite.js.map