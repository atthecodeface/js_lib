...
class Main {
    constructor() {
        ...
        this.div = new html.HtmlElement(document.getElementById("TestArea"));
        this.div.add_input_button("Alert button", () => window.alert("Alert button clicked!"), { classes: "test item" });
        ...
        radio_table.add_body([
            html.HtmlElement.new_ele("div", {}, [], (e) => {
                e.add_input_radio("radio1", "sel1", true, this.radio1_selected.bind(this), { classes: "radio1 button" }).set_input_checked(true);
                e.add_label("sel1").add_content("Radio Item 1");
            }),
            html.HtmlElement.new_ele("div", {}, [], (e) => {
                e.add_input_radio("radio1", "sel2", true, this.radio1_selected.bind(this), { classes: "radio1 button" });
        ...
        radio_table2.add_body([
            html.HtmlElement.new_ele("div", {}, [], (e) => {
                e.add_input_radio("radio2", "radio2_sel1", true, this.radio2_selected.bind(this), { classes: "radio2 button" });
                e.add_label("radio2_sel1").add_content("Opt radio 1");
            }),
            html.HtmlElement.new_ele("div", {}, [], (e) => {
                e.add_input_radio("radio2", "radio2_sel2", true, this.radio2_selected.bind(this), { classes: "radio2 button" });
        ...
        this.div.add_input_dropdown("dropdown_any", [
            ["value1", "label1"],
            ["value2", "label2"],
        ], "value1", false, false, this.dropdown.bind(this), { classes: "test item" });
        this.div.add_input_dropdown("dropdown_multiple", [
            ["value1", "label1"],
            ["value2", "label2"],
        ], null, false, true, this.dropdown_many.bind(this), { classes: "test item" });
        this.div.add_input_range("float_range", { min: 100, max: 110, step: 0.1 }, this.float_range.bind(this), { classes: "test item" });
        this.div.add_input_range("int_range", { min: -50, max: 50, step: 1 }, (_e, value) => {
            this.int_range(value, "-50 to 50");
        }, { classes: "test item" });
        this.div.add_input_range("int_range", { min: -500, max: 0, step: 10 }, (_e, value) => {
    ...
    radio1_selected(_e, value) {
        this.log_src.info("Radio 1 selected " + value);
    }
    radio2_selected(_e, value) {
